...
![component]({{site.baseurl}}/ariexpress/images/component.png)
...
![route]({{site.baseurl}}/ariexpress/images/route.png)
...
> [このフローチャート](./summary.html)を、各自のスマホで確認しながらプレイすることをおすすめします。
...
![dice_square]({{site.baseurl}}/ariexpress/images/dice_square.png)

新たな線路を作ったら、その始点と終点のダイスマスには自動的にあなたの働きアリが配置されます。その２マスを自身のカラーペンでマークしてください（ダイスマスに描かれている目は何でもかまいません）。

![mark]({{site.baseurl}}/ariexpress/images/mark.png)
