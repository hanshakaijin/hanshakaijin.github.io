(function ($) {
  ...
  var SPECIAL_RESPONSE = [
    ...
    "<p>以下は今回の顛末になります。</p>",
    "<p>お気づきになられた方も多いと思いますが、本ゲームにおいて、炎上対象となるインフルエンサーにはモデルとなる人物が存在します。ただし、当然そのまま用いるわけにはいきませんので、ぼかした形でアレンジしています（誹謗中傷やネガティブな印象を与えないような調整をしています）。</p>",
    "<p>そのうちの1人の方において、ゲーム制作中に「想定外の事象」が発生しました。</p>",
    ...
    "<p>追伸：このインフルエンサーに何が起こったのか、詳細がはっきりしていません。もしご興味がありましたら、ご自身で調べていただくのも良いかと存じ上げます。</p>",
    "<p>反社会人サークル</p>"
  ].join("");
